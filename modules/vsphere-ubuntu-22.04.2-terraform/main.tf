## This is the main Terraform configuration file for the module vsphere-ubuntu-22.04.2-terraform
## Author Joe Harrison
...
resource "vsphere_virtual_machine" "vm" {
  ...
  provisioner "remote-exec" {
    inline = [
      "sudo hostnamectl set-hostname ${var.deployment_name}",
      "chmod +x /tmp/disk_filesystem.sh",
